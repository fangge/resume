                ...
                <div className="item">
                  <div className="item-bd">
                    <div className="section-content">
                      <p>
                        资深前端开发工程师，精通移动端 H5 开发，擅长工程化体系搭建、组件化沉淀与 AI 赋能效率提升。主导虎牙 DIY 平台、支付、认证、中间页等核心业务线前端架构设计，自研 3 个核心 npm 包，沉淀 50+ 通用业务组件，覆盖 90% 以上营收活动场景，单个活动开发周期缩短 50%。深度运用 LLM 与 AI 辅助开发，基于 Dify 平台落地 AI 智能助手与 Prompt 工程体系；持续研究 AI Agent、端智能等前沿技术，具备极强的跨团队协作与问题排查能力。
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <section className="project">
              ...
              <div className="section-bd">
                <div className="item">
                  ...
                  <div className="item-bd">
                    <p className="item-subtitle">技术栈：React、Taro</p>
                    
                    <ul className="section-content">
                      <li>覆盖了广东省和港澳地区可以带娃去玩的地点，用户可以提交地点、评论地点，还能根据用户现有的地点，推荐附近的游玩场所</li>
                    </ul>
                  </div>
                </div>
              </div>
