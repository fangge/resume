                ...
                <div className="item">
                  <div className="item-bd">
                    <ul className="section-content">
                      <li>熟悉<i>HTML5/CSS3</i>，能<i>快速还原</i>设计稿，并做好浏览器兼容设计</li>
                      <li>熟练掌握<i>JQuery</i>，熟系<i>React和Vue</i>技术栈，具备<i>跨终端</i>（PC+Mobile）开发能力</li>
                      <li>了解<i>Webpack</i>自动化构建工具，能根据业务开发对应的脚手架</li>
                      <li>具备良好的<i>团队协作</i>精神，能利用自身技术能力<i>提升团队整体研发效率</i>，<i>提高团队影响力</i></li>
                      <li>对前端技术有<i>持续的热情</i>，个性乐观开朗，逻辑性强，<i>善于和各种背景的人合作</i></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="section-bd">
                <div className="item">
                  ...
                  <div className="item-bd">
                    ...
                    <ul className="section-content">
                      <li>
                        工作期间开发了能让运营上传日常素材的素材库让开发可以定义线上json数据的的虎牙Api和能让运营通过搭积木方式开发日常运营赛事所需专题的等等相关功能
                      </li>
                      <li>
              ...
              <div className="section-bd">
                <div className="item">
                  ...
                  <div className="item-bd">
                    <ul className="section-content">
                      <li>
                        主要负责小鹿陪练app中技能认证页面的技能认证、公会申请等所有功能实现，负责期间对整体项目模块化搭建，将技能认证相关功能解耦，提高了功能迭代开发的工作效率
                      </li>
                    </ul>
                  </div>
                </div>
